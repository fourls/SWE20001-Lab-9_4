...
<form action = "action/searchrecord.php" method = "post" >
	<fieldset>
		...
		<p><label for="product_id">Product ID: </label> 
			<input type="text" id="product_id" name= "product_id" placeholder="Enter Product ID to search" />
		</p>
		<p><label for="sale_id">Sale ID: </label> 
			<input type="text" id="sale_id" name= "sale_id" placeholder="Enter Product ID to search" />
		</p>
